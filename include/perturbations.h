...
struct perturbations
{
  ...
  short has_source_delta_wspl;  /**< do we need source for delta of dark energy SPLINE? */
  short has_source_theta_wspl;  /**< do we need source for theta of dark energy SPLINE? */
  ...
  int index_tp_delta_p_fld;  /**< index value for delta of dark energy */
  int index_tp_delta_rho_fld;  /**< index value for delta of dark energy */
  ...
  int index_tp_delta_wspl;  /**< index value for delta of dark energy SPLINE*/
  int index_tp_delta_p_wspl;  /**< index value for delta of dark energy SPLINE*/
  int index_tp_delta_rho_wspl;  /**< index value for delta of dark energy SPLINE*/
  ...
  int index_tp_theta_wspl;   /**< index value for theta of dark energy SPLINE*/
...
struct perturbations_vector
{
  ...
  int index_pt_delta_wspl;  /**< dark energy density in true fluid case SPLINE*/
  int index_pt_theta_wspl;  /**< dark energy velocity in true fluid case SPLINE*/
  int index_pt_Gamma_wspl;  /**< unique dark energy dynamical variable in PPF case SPLINE*/
...
struct perturbations_workspace
{
  ...
  */
  ...
  double delta_rho_wspl;        /**< density perturbation of fluid, not so trivial in PPF scheme */
  double delta_p_wspl;          /**< pressure perturbation of fluid, very non-trivial in PPF scheme */
  double rho_plus_p_theta_wspl; /**< velocity divergence of fluid, not so trivial in PPF scheme */
  double S_wspl;                /**< S quantity sourcing Gamma_prime evolution in PPF scheme (equivalent to eq. 15 in 0808.3125) */
  double Gamma_prime_wspl;      /**< Gamma_prime in PPF scheme (equivalent to eq. 14 in 0808.3125) */
